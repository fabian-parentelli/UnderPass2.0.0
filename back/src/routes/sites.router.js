...
export default class SitesRouter extends Router {
    init() {
        ...
        this.get('/id/:id', ['USER', 'ADMIN', 'MASTER'], passportEnum.JWT, sitesController.getById);
        ...
        this.put('/shift/:id', ['USER', 'ADMIN', 'MASTER'], passportEnum.JWT, sitesController.updIsShift);
    };
};