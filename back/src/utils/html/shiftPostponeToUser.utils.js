...
async function shiftPostponeToUserHTML(title, postpone, result) {
        ...
        <!DOCTYPE html>
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        Hola <span class="highlight">${postpone.shift.customerData.name}</span>,
                        <p>
                            En la fecha <span class="highlight">${new Date(result.date).toLocaleDateString()}</span>, has recibido una propuesta de posponer la reserva que has realizado en <span class="highlight">${title}</span> el día <span class="highlight">${postpone.shift.day.day} - ${postpone.shift.day.month} - ${postpone.shift.day.year}</span> a las <span class="highlight">${postpone.shift.hour.join(' - ')}</span> horas.
                        </p>
                        <p>
...
export { shiftPostponeToUserHTML };