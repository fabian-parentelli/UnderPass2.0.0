import { shiftRepository, postponeRepository, alertsRepository, customerRepository } from "../../../repositories/index.repositories.js";
...
const updateDateShift = async (id, shift, user) => {
    ...
    const postponeDB = await postponeRepository.getByAdminId(shiftDB.userId, true, false);
